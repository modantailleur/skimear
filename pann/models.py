...
from pann.pytorch_utils import do_mixup, interpolate, pad_framewise_output
...
#MT: added
class ResNet38Mels(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        fmax, classes_num):
        
        super(ResNet38Mels, self).__init__()
...
#MT: added for inference on Mel spectrogram
############
class Cnn14_DecisionLevelMaxMels(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        fmax, classes_num):
        
        super(Cnn14_DecisionLevelMaxMels, self).__init__()
